/* ===== Dummy data for YARSI Sistem Akuntansi Keuangan ===== */
...
/* ---------- Buku Besar (akun 1202 Piutang BPJS) ---------- */
const BUKU_BESAR_BPJS = {
...
window.YarsiData = {
  fmtIDR, fmtIDRShort, fmtDate,
  ACCOUNTS, COST_CENTERS, JOURNALS,
  DASHBOARD_KPI, PIUTANG_JT, UTANG_JT, PENDING_APPROVAL,
  REVENUE_TREND, PENDAPATAN_UNIT, LABA_RUGI,
  BUKU_BESAR_BPJS, TRIAL_BALANCE, PIUTANG, NERACA, COA_TREE,
};
